...
import Counter from "../likes";
import Block from "../likes";
                ...
                <div id="card">
                    <div id="card-content" className='row align-items-center p-4 py-0'>
                        ...
                        <a className= "text-decoration-none" href={`/adoption/${pet.id}`}>
                            <img className="rounded mx-auto d-block" src={pet.pic} alt={pet.name}></img></a>
                    ...
                    <div id="card-content-buttons" className='text-center mx-auto d-block'>
                        ...
                        <button id="like-counter" type="submit" className="btn btn-danger mx-2 my-1" >
                        ...
                        <button id="comment-counter" type="submit" className="btn btn-success mx-2 my-1">
