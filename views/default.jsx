            ...
            <footer className="text-center text-white">
                <div className="container pt-4">
                    ...
                    <section className="mb-4">
                        ...
                        <a className="btn btn-link btn-floating btn-lg text-dark m-1" href="#!" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        <a className="btn btn-link btn-floating btn-lg text-dark m-1" href="#!" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="bi bi-linkedin" viewBox="0 0 16 16">
