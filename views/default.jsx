                ...
                <div className="row mt-3">
                  ...
                  <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    <h6 className="text-uppercase fw-bold">Team Profiles</h6>
                      <hr className="mb-4 mt-0 d-inline-block mx-auto"/>
                        <p>
                          <a className="text-dark text-decoration-none" href="https://github.com/alissamak">
                  ...
                  <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                    <h6 className="text-uppercase fw-bold">Pages</h6>
                      <hr className="mb-4 mt-0 d-inline-block mx-auto"/>
                        ...
                        <p>
                          <a href="/adoption" className="text-dark">Adoption</a>
                        </p>
                        <p>
                          <a href="/services" className="text-dark">Services</a>
                        </p>
                        <p>
                          <a href="/events" className="text-dark">Events</a>
                        </p>
                  </div>
