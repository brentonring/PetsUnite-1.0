                ...
                <div>
                    ...
                    <div className='row'>
                        <div className='form-group col-sm-6'>
                            ...
                            <input className='form-control' id='start_time' name='start_time' defaultValue={event.start_time}/>
                        </div>
                        <div className='form-group col-sm-6'>
                            <label className='col-form-label' htmlFor='end_time'>End Time</label>
                            <input className='form-control' id='end_time' name='end_time' defaultValue={event.end_time}/>
                        </div>
                    </div>
                    <div className='row'>
                        <div className='form-group col-sm-6'>
                            <label className='col-form-label' htmlFor='location'>Location</label>
                            <input className='form-control' id='location' name='location' placeholder='e.g. PetSmart, Reedy Creek Dog Park, etc.' defaultValue={event.location}/>
                        </div>
                        <div className='form-group col-sm-6'>
