                ...
                <div>
                    <form method='POST' action={`/services/${service._id}?_method=PUT`}>
                        <div className='form-group col-sm-6'>
                            ...
                            <input className='form-control' required id='service' name='service' defaultValue={service.service}/>
                        </div>
                        ...
                        <div className='form-group col-sm-4'>
                            ...
                            <input className='form-control' id='health_history' name='health_history' defaultValue={service.health_history}/>
                        </div>
                        <div className='form-group col-sm-4'>
                        ...
                        <div className='form-group col-sm-12'>
                            ...
                            <textarea className='form-control' id='details' name='details' rows='3' defaultValue={service.details}/>
                        </div>
